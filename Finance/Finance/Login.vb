...
Public Class Login
    ...
    Private Sub checkrole()
        ...
        If dr.Read() Then
            ...
            If lblRole.Text = "Cashier" Or lblRole.Text = "Admin" Then
                Call CheckAndLogin()
            Else
                MsgBox("Access Denied. You're neither the Cashier nor the Admin.", MsgBoxStyle.Exclamation, "Warning")
            End If
        Else
    ...
    Private Sub PerformLogin()
        ...
        If dr.Read() Then
            ...
            financedashboard.lbluser.Text = fullname
            financedashboard.lblrole.Text = Me.lblRole.Text
            MsgBox("Login Success", MsgBoxStyle.Information)
            financedashboard.Show()
            Call clear()
            ActLogs("Logged In")
        Else
    ...
    Private Sub txtUsername_TextChanged(sender As Object, e As EventArgs) Handles txtUsername.TextChanged
        ...
        ' Create a new command and add the parameter
        cmd = New OleDbCommand(sql, cn)
        cmd.Parameters.AddWithValue("@Username", txtUsername.Text)
        ...
        ' If a record is found, populate the labels
        If dr.Read() Then
            ' Get lastname and firstname from the data reader
            Dim lastname As String = dr("lastname").ToString()
            Dim firstname As String = dr("firstname").ToString()
