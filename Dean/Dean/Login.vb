...
Public Class Login
    ...
    Private Sub PerformLogin()
        ...
        If dr.Read() Then
            ...
            Dean.tssUsername.Text = Me.txtUsername.Text
            Dean.tssRole.Text = Me.lblRole.Text
            Dean.tssDateTime.Text = Now.ToString
            Dean.Show()
            Me.Hide()
            clear()
            ' ActLogs("Logged In")
    ...
    Private Sub DeanLogin_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Call connection()
    End Sub
